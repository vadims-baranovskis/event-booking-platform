...
<head>
    ...
    <title>Edit Event | Event Booking Platform</title>
        ...
        <section class="admin-form-card">
            ...
            <form method="POST" action="{{ route('admin.events.update', $event) }}" class="admin-form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="available_tickets" name="available_tickets" value="{{ old('available_tickets', $event->available_tickets) }}" min="0" required>
